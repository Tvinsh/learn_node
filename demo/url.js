...
// parse    将url字符串，解析成object，便于开发者进行操作

// format    .parse() 方法的反向操作
...
// //var obj = url.parse(str);		//query: 'nick=%E7%A8%8B%E5%BA%8F%E7%8C%BF%E5%B0%8F%E5%8D%A1',

// var obj = url.parse(str, true);	// query: { nick: '程序猿小卡' }   对参数值进行 decode
// console.log(obj);
...
var obj = url.parse(str, true, false);	// pathname: '//foo/bar',  path: '//foo/bar',
console.log(obj);

obj = url.parse(str, true, true);		//  pathname: '/bar', path: '/bar',
console.log(obj);
